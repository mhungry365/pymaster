  ...
  return (
    <section className="mt-6 rounded-3xl border border-amber-300/20 bg-amber-300/10 p-6 sm:p-8">
      ...
      <button
        ...
        className="mt-6 inline-flex h-12 items-center justify-center rounded-full border border-amber-300/40 px-6 text-sm font-semibold text-slate-950 transition hover:bg-amber-300/10"
      >
        Reset Progress
      </button>
    </section>
