  ...
  return (
    <section className="grid gap-6 lg:grid-cols-2">
      <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
        ...
        <p className="mt-3 leading-7 text-slate-300">{fillBlank.prompt}</p>
        ...
        <div className="mt-6 rounded-2xl bg-slate-950 p-5 font-mono text-sm leading-7 text-slate-200">
          ...
          <input
            ...
            className="mx-1 w-40 rounded-lg border border-white/10 bg-slate-900 px-3 py-2 text-emerald-200 outline-none transition placeholder:text-slate-600 focus:border-emerald-300"
          />
      ...
      <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
        ...
        <p className="mt-3 leading-7 text-slate-300">{task.prompt}</p>
        ...
        <textarea
          ...
          className="mt-6 min-h-36 w-full resize-y rounded-2xl border border-white/10 bg-slate-950 p-4 font-mono text-sm leading-6 text-slate-200 outline-none transition placeholder:text-slate-600 focus:border-emerald-300"
        />
      </div>
    </section>
  );
