  ...
  return (
    <div className="rounded-3xl border border-amber-400/30 bg-amber-400/10 p-6">
      <div className="flex items-center gap-3">
        ...
        <h3 className="text-xl font-black text-white">Common Mistake</h3>
      </div>

      <div className="mt-5 grid gap-4 md:grid-cols-2">
        <div>
          <p className="mb-2 text-sm font-bold text-red-300">Wrong</p>
          <pre className="rounded-2xl bg-slate-950 p-4 text-sm text-red-200">
            <code>{wrongCode}</code>
          </pre>
        </div>
        ...
        <div>
          ...
          <pre className="rounded-2xl bg-slate-950 p-4 text-sm text-emerald-200">
